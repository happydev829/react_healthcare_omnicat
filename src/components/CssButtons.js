...
const CssButtons = () => {
  ...
  return (
    <div id="css-button">
      ...
      <div className="first-border flex color-bright">
      ...
      <div className="first-border flex color-bright">
        ...
        <div className="button flex up">SEND MAIL</div>
      ...
      <div className="first-border flex color-bright">
        ...
        <div className="button flex up">SETTINGS</div>
        <div className="button" />
      </div>
      ...
      <div className="first-border flex color-bright">
        ...
        <div className="button flex up">SEARCH</div>
        <div className="button" />
      </div>
      {/* SAVE ... CANCEL */}
