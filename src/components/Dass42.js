  ...
  return (
    <div className="dass">
      ...
      <h3 id="leading-statement" className="message">
        ...
        <b>over the past week</b>. There are no right or wrong answers. Do not
        spend too much time on any statement.
      </h3>
      <CSSTransition
        in={!begin && !results.scores}
        timeout={300}
        classNames="message"
      >
        {() =>
          begin || (
            <div className="message">
              <div className="card m-3 p-3 shadow">
                <br />
                0, if the statement does not apply to me at all, or&mdash;
                <br />
                1, if it applies to me to some degree, or some of the time
                <br />
                2, if it applies to me to a considerable degree, or a good part
                of time
                <br />
                3, if it applies to me very much, or most of the time
              </div>
              <button
                href="#"
      ...
      <CSSTransition
        in={begin && !results.scores}
        timeout={300}
        classNames="transition-statements"
      >
        {() =>
          (begin && !results.scores && (
            <Dass42Form
              handleSubmit={handleSubmit}
              className="transition-statements"
...
const Dass42Form = props => {
  ...
  return (
    <form className="dass xlensCursor" onSubmit={props.handleSubmit}>
      ...
      <button
        style={{ display: canSubmit(props.selections) }}
        type="submit"
