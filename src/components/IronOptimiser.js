...
const IronOptimiser = () => {
  ...
  const tallyResults = () => {
    ...
    const report_si =
      (si === 20
        ...
        : si < 10
        ? "Abnormal low"
        : "Abnormal high") + " Serum Iron levels";
    const report_ti =
      (ti === 60
        ? "Optimal"
        : ti >= 55 && ti <= 59
        ...
        : ti < 45
        ? "Abnormal low"
        : "Abnormal high") + " TransferrinIBC levels";
    const report_ts =
      (ts === 40
        ? "Optimal"
        : ts >= 35 && ts <= 39
        ...
        : ts < 16
        ? "Abnormal low"
        : "Abnormal high") + " Transferrin Saturation levels";
    const report_sfa =
      (sfa === 150
        ? "Optimal"
        : sfa >= 130 && sfa <= 149
        ...
        : sfa < 20
        ? "Abnormal low"
        : "Abnormal high") + " Serum Ferritin Assay levels";
  ...
  const setColorCodes = text => {
    return text.match("Optimal")
      ? "bg-info text-white "
      : text.match("Normal")
      ? "bg-success text-white "
      : text.match("Suboptimal")
        ...
        <div className="card">
          {results.scores && (
            <div>
              ...
              <p
                className={
                  results.color_si + " d-inline-flex p-2 m-1 bd-highlight"
                }
              >
                {results.siPct}% of optimal
              </p>
            </div>
          )}
          <label htmlFor="serumIron">
            {" "}
            Serum Iron
            <input
              type="number"
        ...
        <div className="card">
          {results.scores && (
            <div>
              ...
              <p
                className={
                  results.color_ti + " d-inline-flex p-2 m-1 bd-highlight"
                }
              >
                {results.tiPct}% of optimal
              </p>
            </div>
          )}
          <label htmlFor="transferrinIBC">
            {" "}
            TransferrinIBC
            <input
              type="number"
        ...
        <div className="card">
          {results.scores && (
            <div>
              ...
              <p
                className={
                  results.color_ts + " d-inline-flex p-2 m-1 bd-highlight"
                }
              >
                {results.tsPct}% of optimal
              </p>
            </div>
          )}
          <label htmlFor="transferrinSaturation">
            {" "}
        ...
        <div className="card">
          {results.scores && (
            <div>
              ...
              <p
                className={
                  results.color_sfa + " d-inline-flex p-2 m-1 bd-highlight"
                }
              >
                {results.sfaPct}% of optimal
              </p>
            </div>
          )}
          <label htmlFor="serumFerritinAssay">
            {" "}
            ...
            <input
              ...
              min="0"
              max="999"
              name="serumFerritinAssay"
              defaultValue={results.sfa}
              onFocus={handleFocus}
              onChange={handleChange}
            />
          </label>
